...
const DEFAULTS: Record<string, { title: string; body: string }> = {
  ...
  AD_EXPIRED: { title: "انتهت مدة إعلانك وتم حذفه", body: 'انتهت مدة عرض إعلانك "{ad_title}" ولم يُجدَّد في الوقت المناسب، فتم حذفه نهائياً. يمكنك نشره من جديد في أي وقت.' },
